...

{
     ...
     */
    public
    function it_validates_that_the_type_member_is_given_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_the_type_member_has_the_value_of_books_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_the_attributes_member_has_been_given_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_the_attributes_member_is_an_object_given_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_a_title_attribute_is_a_string_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_a_description_attribute_is_a_string_when_updating_an_book()
    {
     ...
     */
    public
    function it_validates_that_a_publication_year_attribute_is_a_string_when_updating_an_book()
    {
     ...
     */
    public
    function it_can_delete_an_book_through_a_delete_request()
    {
